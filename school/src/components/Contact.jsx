    ...
    >
      ...
      <Container>
        <motion.div
          ...
          variants={fadeInUp}
        >
          <div className="container d-flex flex-column flex-lg-row justify-content-between align-items-start gap-4">
            {/* Contact Form */}
            <motion.div
              className="contact-form bg-white text-dark p-4 rounded-4 shadow-lg flex-fill"
            ...
            {/* Info Text */}
            <motion.div className="info-text flex-fill" variants={fadeInUp}>
              ...
              <p style={{ fontSize: '1.1rem', textAlign: 'justify' }}>
                ...
                Conveniently located in Kathmandu, our school offers accessible, high-quality education.
              </p>
